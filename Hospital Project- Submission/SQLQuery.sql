...
DOB Date, 
employeeID int ,
constraint empplID_fk foreign key(employeeID) references Employee(employeeID) on delete set null
);
...
insert into Patient(patientID,Name,DOB,employeeID) values (1,'Ali','2012-05-02',2);
insert into Patient(patientID,Name,DOB,employeeID) values (2,'Nuha','2007-07-02',3);
insert into Patient(patientID,Name,DOB,employeeID) values (3,'Raneem','1992-09-12',5);
insert into Patient(patientID,Name,DOB,employeeID) values (4,'Sara','1995-05-22',2);
insert into Patient(patientID,Name,DOB,employeeID) values (5,'Khalid','1988-08-18',3);
...
insert into Employee(employeeID,Name,DOB,salary,days,timing,shift,nurse_rank,job_type) values(20,'Hazem','1999-05-24',635.85,'','','A',3,'Nurse');
